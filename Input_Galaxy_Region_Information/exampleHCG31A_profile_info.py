...
example_region.add_em_line(name='H-Alpha', plot_color='y', order=20, filter='red', min_idx=2931, max_idx=3360, rest_wavelength=6562.82, amp_list=[13.5290844, 1.9384663, 6.3288925], zone='low', sigma_tsquared=164.96, comp_limits={'a': np.inf, 'c': np.np.inf, 's': np.np.inf}, copy_from=None)
