...
class RegionParameters(object):
    ...
    emProfiles = OrderedDict([
        ...
        # # H-Beta_Blue:
        # ('H-Beta', {'Colour': 'b', 'Order': 36, 'Filter': 'blue', 'minI': 370, 'maxI': 1613, 'restWavelength': 4861.33,'ampList': [0.2488174, 0.4748407, 3.7794498, 2.0702787], 'zone': 'low', 'sigmaT2': 164.96,'compLimits': {'a': inf, 'c': 0.01, 's': 0.01}, 'copyFrom':'H-Alpha'}),
        ...
        # ('NII-6584A', {'Colour': 'violet', 'Order': 20, 'Filter': 'red', 'minI': 3361, 'maxI': 3885, 'restWavelength': 6583.41, 'ampList': [0.0983902, 0.2332231, 0.9984201, 0.6106288], 'zone': 'low', 'sigmaT2': 11.87, 'compLimits': {'a': inf, 'c': 0.01, 's': 0.01}, 'copyFrom': 'H-Alpha'}),
        ...
        # ('SII-6717A', {'Colour': 'r', 'Order': 22, 'Filter': 'red', 'minI': 508, 'maxI': 985, 'restWavelength': 6716.47, 'ampList': [0.0644916, 0.1415714, 0.605027, 0.6710964], 'zone': 'low', 'sigmaT2': 5.19, 'compLimits': {'a': inf, 'c': 1, 's': 1}, 'copyFrom': 'H-Alpha'}),# ('SII-6731A', {'Colour': '#58D68D', 'Order': 22, 'Filter': 'red', 'minI': 986, 'maxI': 1290, 'restWavelength': 6730.85, 'ampList': [0.0562764, 0.1017221, 0.4416212, 0.4717391], 'zone': 'low', 'sigmaT2': 5.19,'compLimits': {'a': inf, 'c': 1, 's': 1}, 'copyFrom': 'SII-6717A'}),
    ...
    ##
    #3comp
    ('H-Alpha', {'Colour': 'y', 'Order': 20, 'Filter': 'red', 'minI': 2931, 'maxI': 3360, 'restWavelength': 6562.82, 'ampList': [1.7833584, 12.3510137, 6.3829617], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'a': inf, 'c': inf, 's': inf}, 'copyFrom': None}),
    ('OIII-5007A', {'Colour': 'c', 'Order': 4, 'Filter': 'red', 'minI': 2300, 'maxI': 3440, 'restWavelength': 5006.84, 'ampList': [1.5048018, 11.6733837, 6.0130845], 'zone': 'high', 'sigmaT2': 10.39, 'compLimits': {'a': inf, 'c': inf, 's': inf}, 'copyFrom': None}),
    # OIII-4959A_Red:
    ...
    #3comp
    centerList = {'low': [3962.62266, 4001.71844, 3988.40713], 'high': [3966.47756, 4000.24559, 3995.04269]}
    sigmaList = {'low': [15.6120818, 40.2420043, 98.1856858], 'high': [12.7580492, 39.1248199, 100.523249]}
    linSlope = {'low': -3.0665e-07, 'high': -3.1810e-07}
    linInt = {'low': 0.00273304, 'high': 0.00286121}
