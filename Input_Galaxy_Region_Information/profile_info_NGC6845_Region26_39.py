...
class RegionParameters(object):
    regionName = "NGC6845-26 39"

    blueSpecFile =  'NGC6845_26B39.fc.fits'             #'NGC6845_26B_SPEC1.wc.fits'
    redSpecFile = 'NGC6845_26R39.fc.fits'              #'NGC6845_26R_SPEC1.wc.fits'
    blueSpecError = 'NGC6845_26B39_ErrorFlux.fc.fits'  #'NGC6845_26B_VAR4.wc.fits'
    redSpecError = 'NGC6845_26R39_ErrorFlux.fc.fits'   #'NGC6845_26R_VAR4.wc.fits'
    scaleFlux = 1e14                                # 1
    ...
    emProfiles = OrderedDict([
        ...
        ('OIII-4959A', {'Colour': 'g', 'Order': 4, 'Filter': 'red', 'minI': 2350, 'maxI': 2700, 'restWavelength': 4958.91, 'ampList': [0.0080434, 0.0391648, 0.0678399], 'zone': 'high', 'sigmaT2': 10.39, 'compLimits': {'c': False, 's': 0.5, 'a': np.inf}, 'copyFrom': 'OIII-5007A'}),
        #H-Beta_Blue:
        ('H-Beta', {'Colour': 'b', 'Order': 36, 'Filter': 'blue', 'minI': 1800, 'maxI': 2400, 'restWavelength': 4861.33, 'ampList': [0.0684742, 0.2145362, 0.026463], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'c': [0.001, 0.001, False], 's': [0.001, 0.001, 0.001], 'a': np.inf}, 'copyFrom': None}),
        ('H-Beta_Red', {'Colour': 'r', 'Order': 3, 'Filter': 'red', 'minI': 1500, 'maxI': 2040, 'restWavelength': 4861.33, 'ampList': [0.0684742, 0.2145362, 0.026463], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'c': [0.001, 0.001, False], 's': [0.001, 0.001, 0.001], 'a': np.inf}, 'copyFrom': None}),
        ...
        ('NII-6584A', {'Colour': 'violet', 'Order': 21, 'Filter': 'red', 'minI': 1650, 'maxI': 2100, 'restWavelength': 6583.41, 'ampList': [0.132274, 0.3275002, 0.0609671], 'zone': 'low', 'sigmaT2': 11.87, 'compLimits': {'c': 0.001, 's': 0.001, 'a':[inf, inf, 0.001]}, 'copyFrom': 'H-Alpha'}),
        ...
        ('SII-6717A', {'Colour': 'r', 'Order': 22, 'Filter': 'red', 'minI': 1700, 'maxI': 2006, 'restWavelength': 6716.47, 'ampList': [0.0334009, 0.0883627, 0.011889], 'zone': 'low', 'sigmaT2': 5.19, 'compLimits': {'c': 0.001, 's': 0.001, 'a': [inf, inf, 0.001]}, 'copyFrom': 'H-Alpha'}),
    ...
    centerList = {'low': [6170.24704, 6190.87950, 6194.56149], 'high': [6168.53269, 6188.32031, 6190]}
    sigmaList = {'low': [18.4455957, 48.8813434, 127.146376], 'high': [19.0587083, 60.4489219, 103.682467]}
    linSlope = {'low': -3.2907e-08, 'high':  1.2632e-08}
    linInt = {'low': 0.00079612, 'high': 0.00108601}
