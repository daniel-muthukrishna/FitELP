...
class RegionParameters(object):
    regionName = "NGC6845-7NewDisp"

    blueSpecFile = 'NGC6845_7BNewDisp.fc.fits'             #'NGC6845_7B_SPEC1.wc.fits'
    redSpecFile = 'NGC6845_7RNewDisp.fc.fits'              #'NGC6845_7R_SPEC1.wc.fits'
