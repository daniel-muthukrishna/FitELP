...
class RegionParameters(object):
    ...
    emProfiles = OrderedDict([
        ('H-Alpha', {'Colour': 'y', 'Order': 1, 'Filter': 'red', 'minI': 840, 'maxI': 960, 'restWavelength': 6562.82, 'ampList': [0.2850907, 0.6838634, 0.2160304], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'a': inf, 'c': inf, 's': inf}, 'copyFrom': None}),
        ('NII-6584A', {'Colour': 'violet', 'Order': 1, 'Filter': 'red', 'minI': 967, 'maxI': 1055, 'restWavelength': 6583.41, 'ampList': [0.0325443, 0.0430167, 0.0249222], 'zone': 'low', 'sigmaT2': 11.87, 'compLimits': {'a': inf, 'c': False, 's': 0.001}, 'copyFrom': None}),
        ...
        ('NII-6548A', {'Colour': 'm', 'Order': 1, 'Filter': 'red', 'minI': 790, 'maxI': 839, 'restWavelength': 6548.03, 'ampList': [0.7744249, 0.1533179, 0.4454696], 'zone': 'low', 'sigmaT2': 11.87, 'compLimits': {'a': inf, 'c': False, 's': 0.01}, 'copyFrom': 'NII-6584A'}),
