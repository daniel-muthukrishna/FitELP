...
class RegionParameters(object):
    ...
    emProfiles = OrderedDict([
        ('H-Alpha', {'Colour': 'y', 'Order': 1, 'Filter': 'red', 'minI': 840, 'maxI': 960, 'restWavelength': 6562.82, 'ampList': [2.1414611, 0.5907574, 0.6220876], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'a': inf, 'c': inf, 's': inf}, 'numComps': 3, 'copyFrom': None}),
        ('NII-6584A', {'Colour': 'violet', 'Order': 1, 'Filter': 'red', 'minI': 967, 'maxI': 1055, 'restWavelength': 6583.41, 'ampList': [2.1414611, 0.5907574, 0.6220876], 'zone': 'low', 'sigmaT2': 11.87, 'compLimits': {'a': inf, 'c': False, 's': False}, 'numComps': 3, 'copyFrom': 'H-Alpha'}),
        ...
        ('OIII-5007A', {'Colour': 'c', 'Order': 1, 'Filter': 'blue', 'minI': 2200, 'maxI': 2700, 'restWavelength': 5006.84, 'ampList': [2.1414611, 0.5907574, 0.6220876], 'zone': 'high', 'sigmaT2': 10.39,  'compLimits': {'a': inf, 'c': inf, 's': inf}, 'copyFrom': None}),
        #OIII-4959A_Red:
    ...
    #centerList = {'low': [83017.03, 83019.04, 83005.87], 'high': [83025.0079, 83027.8400, 83000.3505]}
    centerList = {'low': [8378.906, 8378.95, 8378.662], 'high': [6392.4077, 6392.4517, 6392.1637]}
    #centerList = {'low': [350, 349.9221, 366.1735], 'high': [283, 284.9921, 309.6495]}
    sigmaList = {'low': [69, 10, 183.17], 'high': [72.8603209, 22.0881779, 190.948440]}
    linSlope = {'low':5.2793e-05, 'high': 8.1196e-08}
    linInt = {'low': -0.43999125, 'high': -0.00651050}
