...
class RegionParameters(object):
    ...
    emProfiles = OrderedDict([
       ('H-Alpha', {'Colour': 'y', 'Order': 19, 'Filter': 'red', 'minI': 750, 'maxI': 830, 'restWavelength': 6562.82, 'ampList': [143.1812795, 22.0749222, 46.187506, 34.0532838], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'a': np.inf, 'c': np.inf, 's': np.inf}, 'copyFrom': None, 'numComps': 4}),
        ('OIII-5007A', {'Colour': 'c', 'Order': 2, 'Filter': 'red', 'minI': 1650, 'maxI': 1760, 'restWavelength': 5006.84, 'ampList': [613.726918, 51.3242792, 66.0842939, 14.6123474], 'zone': 'high', 'sigmaT2': 10.39, 'compLimits': {'a': inf, 'c': inf, 's': inf}, 'copyFrom': None, 'numComps': 4}),
       ...
       # ('NII-6584A', {'Colour': 'violet', 'Order': 18, 'Filter': 'red', 'minI': 970, 'maxI': 1060, 'restWavelength': 6583.41, 'ampList': [35.7953199, 5.5187305, 11.5468765, 8.513321], 'zone': 'low', 'sigmaT2': 11.87, 'compLimits': {'a': inf, 'c': inf, 's': inf}, 'copyFrom': 'H-Alpha', 'numComps': 4}),
