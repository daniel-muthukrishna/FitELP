...
class RegionParameters(object):
    ...
    emProfiles = OrderedDict([
       ('H-Alpha', {'Colour': 'y', 'Order': 19, 'Filter': 'red', 'minI': 750, 'maxI': 830, 'restWavelength': 6562.82, 'ampList': [143.1228213, 22.093668, 46.2160506, 34.063987, 20], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'a': np.inf, 'c': np.inf, 's': np.inf}, 'copyFrom': None}),
        ('OIII-5007A', {'Colour': 'c', 'Order': 2, 'Filter': 'red', 'minI': 1650, 'maxI': 1760, 'restWavelength': 5006.84, 'ampList': [293.7221194, 52.7847614, 290.053921, 71.8461562, 6], 'zone': 'high', 'sigmaT2': 10.39, 'compLimits': {'a': [inf, inf, inf, inf], 'c': inf, 's': [inf, inf, inf, inf, 9.5]}, 'copyFrom': None}),
       #('OIII-4959A', {'Colour': 'g', 'Order': 2, 'Filter': 'red', 'minI': 995, 'maxI': 1065, 'restWavelength': 4958.91, 'ampList': 5, 'zone': 'high', 'sigmaT2': 10.39, 'compLimits': {'a': inf, 'c': 0.001, 's': 1}, 'copyFrom': 'OIII-5007A'}),
       #('H-Beta_Blue', {'Colour': 'b', 'Order': 3, 'Filter': 'blue', 'minI': 920, 'maxI': 1060, 'restWavelength': 4861.33, 'ampList': [9.9122054, 6.5330892, 6.8177404, 6], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'a': inf, 'c': 0.01, 's': 0.1}, 'copyFrom': 'H-Alpha'}),
       #('H-Beta_Red', {'Colour': 'r', 'Order': 1, 'Filter': 'red', 'minI': 920, 'maxI': 700, 'restWavelength': 4861.33, 'ampList': [73, 14, 22, 17], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'a': inf, 'c': inf , 's': 1}, 'copyFrom': 'H-Alpha'}),
       #('H-Gamma', {'Colour': 'r', 'Order': 12, 'Filter': 'blue', 'minI': 1220, 'maxI': 1370, 'restWavelength': 4340.47, 'ampList': [10, 2, 5, 4], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'a': inf, 'c': 0.001, 's': False}, 'copyFrom': 'H-Beta_Red'}),
       #('H-Delta', {'Colour': 'c', 'Order': 17, 'Filter': 'blue', 'minI': 1510, 'maxI': 1630, 'restWavelength': 4101.74, 'ampList': [5, 1, 2.5,2], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'a': inf, 'c': 0.001, 's': 1}, 'copyFrom': 'H-Beta_Red'}),
       #('NII-6584A', {'Colour': 'violet', 'Order': 18, 'Filter': 'red', 'minI': 970, 'maxI': 1060, 'restWavelength': 6583.41, 'ampList': [0.2, 0.0, 1.4977191, 0.3], 'zone': 'low', 'sigmaT2': 11.87, 'compLimits': {'a': inf, 'c': inf, 's': inf}, 'copyFrom': 'H-Alpha'}),
       #('NII-6548A', {'Colour': 'violet', 'Order': 18, 'Filter': 'red', 'minI': 600, 'maxI': 670, 'restWavelength': 6548.03, 'ampList': [0.857228, 0.4910719, 0.525187], 'zone': 'low', 'sigmaT2': 11.87, 'compLimits': {'a': inf, 'c': 0.001, 's': False}, 'copyFrom': 'NII-6584A'}),
       ...
       #('OII-3729A', {'Colour': '#5D6D7E', 'Order': 24, 'Filter': 'blue', 'minI': 810, 'maxI': 900, 'restWavelength': 3728.82, 'ampList': [9, 0.0, 36, 12], 'zone': 'low', 'sigmaT2': 10.39, 'compLimits': {'a': False, 'c': 0.0005, 's': inf}, 'copyFrom': 'H-Alpha'}),
       #('OII-3726A', {'Colour': '#5D6D7E', 'Order': 24, 'Filter': 'blue', 'minI': 750, 'maxI': 810, 'restWavelength': 3726.03, 'ampList': [5, 0.0, 21, 8], 'zone': 'low', 'sigmaT2': 10.39, 'compLimits': {'a': inf, 'c': 0.0005, 's': False}, 'copyFrom': 'OII-3729A'}),
       ...
       #('OI-6300A', {'Colour': '#D35400', 'Order': 16, 'Filter': 'red', 'minI': 540, 'maxI': 600, 'restWavelength': 6300.3, 'ampList': [0.3964594, 0.0, 0.4723308, 0.0564203], 'zone': 'low', 'sigmaT2': 10.39, 'compLimits': {'a': inf, 'c': False, 's': False}, 'copyFrom': 'H-Alpha'}),
       #('OI-6364A', {'Colour': '#7D6608', 'Order': 19, 'Filter': 'red', 'minI': 2500, 'maxI': 2620, 'restWavelength': 6363.78, 'ampList': [0.0802379, 0.0, 0.2, 0.1], 'zone': 'low', 'sigmaT2': 10.39, 'compLimits': {'c': np.inf, 's': np.inf, 'a': np.inf}, 'copyFrom': 'H-Alpha'}),
       ...
       #('SII-6717A', {'Colour': '#58D68D', 'Order': 19, 'Filter': 'red', 'minI': 1010, 'maxI': 1100, 'restWavelength': 6716.4,'ampList': [0.7, 0.0, 4, 1], 'zone': 'low', 'sigmaT2': 5.19, 'compLimits': {'a': inf, 'c': False, 's': False},'copyFrom': 'H-Alpha'}),
       #('SII-6731A', {'Colour': '#58D68D', 'Order': 19, 'Filter': 'red', 'minI': 1150, 'maxI': 1270, 'restWavelength': 6730.85, 'ampList': [0.4, 0.0,  2, 0.5], 'zone': 'low', 'sigmaT2': 5.19, 'compLimits': {'a': inf, 'c': False, 's': False}, 'copyFrom': 'SII-6717A'}),
