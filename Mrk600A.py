...
class RegionParameters(object):
    ...
    emProfiles = OrderedDict([
     ...
     ('NII-6584A', {'Colour': 'violet', 'Order': 19, 'Filter': 'red', 'minI': 870, 'maxI': 1085, 'restWavelength': 6583.41, 'ampList': [35.7953199, 5.5187305, 11.5468765, 8.4], 'zone': 'low', 'sigmaT2': 11.87, 'compLimits': {'a':[inf, inf, inf, (0,20)], 'c': [False, False, False, False], 's': [False, False, False, (9.5,10)]}, 'copyFrom': ['H-Alpha', 'H-Alpha', 'H-Alpha','OIII-5007A'], 'numComps': 4}),
