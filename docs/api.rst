...
* :class:`fitelp.line_profile_info.RegionParameters` - Setup region properties
* :func:`fitelp.line_profile_info.RegionParameters.add_em_line` - Add an emission line
* :class:`fitelp.kinematics_calculations.RegionCalculations` - Calculate region kinematics
...
* :func:`fitelp.make_latex_tables.average_velocities_table_to_latex` - Make line profile velocities table
* :func:`fitelp.make_latex_tables.halpha_regions_table_to_latex` - Make region information summary table
