...
class RegionParameters(object):
    ...
    emProfiles = OrderedDict([
        ...
        ('OIII-4959A', {'Colour': 'g', 'Order': 4, 'Filter': 'red', 'minI': 2300, 'maxI': 2700, 'restWavelength': 4958.91, 'ampList': [0.6901857, 3.7348318, 2.7152026], 'zone': 'high', 'sigmaT2': 10.39, 'compLimits': {'c': 0.01, 's': 0.01, 'a': np.inf}, 'copyFrom': 'OIII-5007A'}),
