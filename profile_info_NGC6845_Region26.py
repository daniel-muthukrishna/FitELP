...
class RegionParameters(object):
    ...
    emProfiles = OrderedDict([
        ...
        ('NII-6548A', {'Colour': 'violet', 'Order': 21, 'Filter': 'red', 'minI': 900, 'maxI': 1210, 'restWavelength': 6548.03, 'ampList': [2.2041279, 12.7230117, 2.7156426], 'zone': 'low', 'sigmaT2': 11.87}),
        ('SII-6717A', {'Colour': 'r', 'Order': 22, 'Filter': 'red', 'minI': 1700, 'maxI': 2006, 'restWavelength': 6716.47, 'ampList': [1.8447855, 11.394761, 4.3257803], 'zone': 'low', 'sigmaT2': 5.19}),
    ...
    centerListLowZone = [6170.97557, 6190.04683, 6185.89437]
    sigmaListLowZone = [17.1864991, 47.3997052, 114.190155]
    linSlopeLowZone = -4.2702e-06
    linIntLowZone = 0.07401082
    centerListHighZone = [6170.97557, 6190.04683, 6185.89437]
    sigmaListHighZone = [17.1864991, 47.3997052, 114.190155]
