...
class RegionParameters(object):
    ...
    emProfiles = OrderedDict([
       ...
       # ('OIII-4959A', {'Colour': 'g', 'Order': 4, 'Filter': 'red', 'minI': 2300, 'maxI': 2700, 'restWavelength': 4958.91, 'ampList': [0.6901857, 3.7348318, 2.7152026], 'zone': 'high', 'sigmaT2': 10.39, 'compLimits': {'c': 0.01, 's': 0.05, 'a': np.inf}, 'copyFrom': 'OIII-5007A'}),
        ('H-Beta', {'Colour': 'b', 'Order': 36, 'Filter': 'blue', 'minI': 2000, 'maxI': 2700, 'restWavelength': 4861.33, 'ampList': [6.7333334, 36.9536855, 5.8906862], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'c': 0.01, 's': 0.05, 'a': np.inf}, 'copyFrom': 'H-Alpha'}),
        ...
        ('H-Delta', {'Colour': 'c', 'Order': 23, 'Filter': 'blue', 'minI': 1550, 'maxI': 1850, 'restWavelength': 4101.74, 'ampList': [2.1928076, 8.0472948, 1.3214173], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'c': 0.001, 's': 0.02, 'a': np.inf}, 'copyFrom': 'H-Beta'}),
