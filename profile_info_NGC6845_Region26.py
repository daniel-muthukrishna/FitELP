...
class RegionParameters(object):
    ...
    emProfiles = OrderedDict([
        ...
        ('OIII-5007A', {'Colour': 'c', 'Order': 5, 'Filter': 'red', 'minI': 1600, 'maxI': 2100, 'restWavelength': 5006.84, 'ampList': [2.3894212, 9.5687333, 9.6015654], 'zone': 'high', 'sigmaT2': 10.39, 'compLimits': {'c': np.inf, 's': np.inf, 'a': np.inf}, 'copyFrom': None}),
        ...
        ('H-Beta_Blue', {'Colour': 'b', 'Order': 36, 'Filter': 'blue', 'minI': 2000, 'maxI': 2700, 'restWavelength': 4861.33, 'ampList': [6.7333334, 36.9536855, 5.8906862], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'c': 0.01, 's': 0.05, 'a': np.inf}, 'copyFrom': 'H-Alpha'}),
