...
emProfiles = OrderedDict([
    ...
    ('H-Beta', {'Colour': 'g', 'Order': 36, 'Filter': 'blue', 'minI': 2000, 'maxI': 2600, 'restWavelength': 4861.33, 'ampList': [6.7826304, 6.2436831, 36.6678634], 'zone': 'low', 'sigmaT2': 164.96}),
    ('H-Gamma', {'Colour': 'r', 'Order': 28, 'Filter': 'blue', 'minI': 500, 'maxI': 1000, 'restWavelength': 4340.47, 'ampList': [3.6187674, 9.2706367, 12.7007289], 'zone': 'low', 'sigmaT2': 164.96}),
    ('H-Delta', {'Colour': 'c', 'Order': 23, 'Filter': 'blue', 'minI': 1300, 'maxI': 1800, 'restWavelength': 4101.74, 'ampList': [1.3399045, -8.5256671, -0.6113868], 'zone': 'low', 'sigmaT2': 164.96}),
