...
class RegionParameters(object):
    ...
    blueSpecFile = 'NGC6845_26B_SPEC1.wc.fits'
    redSpecFile = 'NGC6845_26R_SPEC1.wc.fits'
    blueSpecError = 'NGC6845_26B_VAR4.wc.fits'
    redSpecError = 'NGC6845_26R_VAR4.wc.fits'
    scaleFlux =  1

    # SPECTRAL LINE INFO FOR ALL EMISSION LINES
    emProfiles = OrderedDict([
        ('H-Alpha', {'Colour': 'y', 'Order': 21, 'Filter': 'red', 'minI': 1180, 'maxI': 1700, 'restWavelength': 6562.82, 'ampList': [790129.8882599, 633251.2635997, 7.4417e+05, 8e+05], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'c': np.inf, 's':np.inf, 'a': np.inf}, 'copyFrom': None}),
       ...
       # ('OIII-4959A', {'Colour': 'g', 'Order': 4, 'Filter': 'red', 'minI': 2300, 'maxI': 2700, 'restWavelength': 4958.91, 'ampList': [0.6901857, 3.7348318, 2.7152026], 'zone': 'high', 'sigmaT2': 10.39, 'compLimits': {'c': 0.01, 's': 0.05, 'a': np.inf}, 'copyFrom': 'OIII-5007A'}),
        ('H-Beta', {'Colour': 'b', 'Order': 36, 'Filter': 'blue', 'minI': 2000, 'maxI': 2700, 'restWavelength': 4861.33, 'ampList': [790129.8882599, 633251.2635997, 7.4417e+05, 8e+05], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'c': np.inf, 's': np.inf, 'a': np.inf}, 'copyFrom': 'H-Alpha'}),
        #('H-Gamma', {'Colour': 'c', 'Order': 28, 'Filter': 'blue', 'minI': 600, 'maxI': 1100, 'restWavelength': 4340.47, 'ampList': [3.4047666, 14.3428947, 4.6305676], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'c': 0.001, 's': 0.02, 'a': np.inf}, 'copyFrom': None}),
        # ('H-Delta', {'Colour': 'c', 'Order': 23, 'Filter': 'blue', 'minI': 1550, 'maxI': 1850, 'restWavelength': 4101.74, 'ampList': [2.1928076, 8.0472948, 1.3214173], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'c': np.inf, 's': np.inf, 'a': np.inf}, 'copyFrom': 'H-Beta'}),
    ...
    centerList = {'low': [6170.97557, 6190.04683, 6185.89437, 6180], 'high': [6170.97557, 6190.04683, 6185.89437]}
    sigmaList = {'low': [17.1864991, 47.3997052, 114.190155, 100], 'high': [17.1864991, 47.3997052, 114.190155]}
    linSlope = {'low': 0.03251003, 'high': 3.7183e-06}
    linInt = {'low': 182.775345, 'high': 0.04636879}

    numComps = 2
    componentLabels = ['Narrow 1', 'Narrow 2', 'Broad', 'Narrow 3']
    componentColours = ['b', 'r', 'g', 'y']
