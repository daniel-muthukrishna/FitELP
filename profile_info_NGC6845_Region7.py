...
class RegionParameters(object):
    ...
    emProfiles = OrderedDict([
        ...
        ('H-Delta', {'Colour': 'c', 'Order': 23, 'Filter': 'blue', 'minI': 1400, 'maxI': 2000, 'restWavelength': 4101.74, 'ampList': [2.433627, 1.603022, 3.289772], 'zone': 'low', 'sigmaT2': 164.96, 'compLimits': {'c': [False, np.inf, np.inf], 's': 0.05, 'a': np.inf}, 'copyFrom': 'H-Alpha'}),
        ...
        # ('HeIH8-3889A', {'Colour': '#5B2C6F', 'Order': 18, 'Filter': 'blue', 'minI': 2450, 'maxI': 2750, 'restWavelength': 3888.65, 'ampList': [2.1000008, 4.4749598, 0.0491407], 'zone': 'low', 'sigmaT2': 41.54, 'compLimits': {'c': np.inf, 's': np.inf, 'a': np.inf}, 'copyFrom': 'H-Alpha'}),
         ('HeI-5876A', {'Colour': '#641E16', 'Order': 15, 'Filter': 'red', 'minI': 1320, 'maxI': 1700, 'restWavelength': 5875.64, 'ampList': [0.6507063, 1.1013801, 0.857102], 'zone': 'low', 'sigmaT2': 41.54, 'compLimits': {'c': False, 's': np.inf, 'a': np.inf}, 'copyFrom': 'H-Beta'}),
        ...
        ('HeI-6678A', {'Colour': '#D5D8DC', 'Order': 22, 'Filter': 'red', 'minI': 1050, 'maxI': 1240, 'restWavelength': 6678.15, 'ampList': [0.2486772, 0.0866339, 0.2718688], 'zone': 'low', 'sigmaT2': 41.54, 'compLimits': {'c': False, 's': np.inf, 'a': np.inf}, 'copyFrom': 'HeI-5876A'}),
