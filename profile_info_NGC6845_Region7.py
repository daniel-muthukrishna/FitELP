...
class RegionParameters(object):
    ...
    emProfiles = OrderedDict([
        ...
        # ('OI-6300A', {'Colour': '#D35400', 'Order': 19, 'Filter': 'red', 'minI': 1050, 'maxI': 1250, 'restWavelength': 6300.3, 'ampList': [0.3964594, 0.4723308, 0.0564203], 'zone': 'low', 'sigmaT2': 10.39, 'compLimits': {'a': inf, 'c': 0.001, 's': 0.1}, 'copyFrom': 'H-Alpha'}),
